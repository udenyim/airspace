    ...
    return (
        <Link to={`/listing/${id}`}className="rounded-md overflow-hidden min-h-44 md:min-h-56 hover:-translate-y-1 hover:shad bg-white group">
            <div className="h-32 w-full overflow-hidden relative">
                <div className="bg-slate-700 group-hover:bg-orange-500 py-1 px-4 w-32 rounded-2x1 text-xs sm text-white text-center absolute z-10 top-4 left-3">{price.toLocaleString()}</div>
